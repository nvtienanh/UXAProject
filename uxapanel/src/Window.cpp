...
//    std::cout << LeftFootTrajectory.AlignedMapType<< sep;
    ...
    std::cout << "LEFT FOOT POSE:" << std::endl;
    std::cout <<leftFootBody->getGlobalPose()<< std::endl;
    std::cout << "RIGHT FOOT POSE:" << std::endl;
    std::cout <<rightFootBody->getGlobalPose()<< std::endl;
	setupUI();
