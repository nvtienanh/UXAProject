...
set(CPACK_PACKAGE_NAME "uxapanel")

if(APPLE)
  set(CPACK_PACKAGE_VENDOR "nvtienanh") # PackageMaker doesn't like http://
else()
  set(CPACK_PACKAGE_VENDOR "http://nvtienanh.com") # deb lintian insists on URL
endif()

set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "uxapanel project")
set(CPACK_PACKAGE_CONTACT "Person name <nvtienanh@gmail.com>")
